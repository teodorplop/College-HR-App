  ...
  <asp:Panel ID="MainPanel" CssClass="container" runat="server">
    ...
    <asp:Table ID="Past_InterviewsTable" CssClass="table table-hover mb-5" runat="server">
      <asp:TableHeaderRow runat="server">
        <asp:TableHeaderCell runat="server" Text="Interviewer"/>
    ...
    <asp:Button ID="ApplyChanges" CssClass="btn btn-success mx-auto" Text="Apply" OnClick="ApplyChanges_Click" runat="server" />
  </asp:Panel>
</asp:Content>
